...
_commander2.default.version('1.0.0').description('Portfolium Deploy Tool (pdt)');
...
_commander2.default.command('checkout <app> [branch]').alias('co').description('checkout specified branch').action(_commands.checkout);
